...
const featureCardsData = [
  ...
  },
  {
    ...
    ), // Placeholder for Innovation icon
  },
  {
  ...
  },
  {
    ...
    ), // Placeholder for Excellence icon
  },
  {
    ...
    ), // Placeholder for Shared Success icon
  },
];
        ...
        <div className={`${commonContainerClasses} bg-gray-950 text-gray-200`}>
          ...
          <div className={`absolute top-0 left-1/2 -translate-x-1/2 z-10`}>
            <div className={`${commonTopIconContainerClasses} bg-gray-800 border-[2px] border-gray-700 shadow-lg`}>
              <img src={logo} alt="Logo Icon" className="w-8 h-8 object-contain" />
            </div>
          </div>
          ...
          <div className={commonRightContentClasses}>
            <h2 className={`${commonMainHeadingClasses} text-white`}>
              How We <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-yellow-400 text-transparent bg-clip-text">Thrive</span>
            </h2>
            ...
            <div className={commonFeaturesGridClasses}>
              {featureCardsData.map((card, index) => (
                <div key={index} className={`${commonFeatureCardClasses} bg-gray-800 border-[1px] border-gray-700`}>
                  <div className={`${commonFeatureIconContainerClasses} bg-purple-700 text-white`}>
                    {card.icon}
                  </div>
                  <h3 className={`${commonFeatureTitleClasses} text-white`}>
                    {card.title}
                  </h3>
        ...
        <div className={`${commonContainerClasses} bg-white text-gray-800`}>
          ...
          <div className={commonRightContentClasses}>
            <h2 className={`${commonMainHeadingClasses} text-gray-900`}>
              How We <span className="bg-gradient-to-r from-purple-600 via-blue-500 to-yellow-500 text-transparent bg-clip-text">Thrive</span>
            </h2>
            ...
            <div className={commonFeaturesGridClasses}>
              {featureCardsData.map((card, index) => (
                <div key={index} className={`${commonFeatureCardClasses} bg-white border-[1px] border-gray-200`}>
                  <div className={`${commonFeatureIconContainerClasses} bg-purple-500 text-white`}>
                    {card.icon}
                  </div>
                  <h3 className={`${commonFeatureTitleClasses} text-gray-900`}>
                    {card.title}
                  </h3>
