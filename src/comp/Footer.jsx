  ...
  return (
    <footer className="relative bg-black text-gray-300 py-12 overflow-hidden">
      ...
      */}
      <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 pb-12">
        ...
        <div className="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-1">
          <div className="flex items-center mb-4">
            ...
            <img src={logo} alt="Everything Talent Logo" className="h-10 w-auto mr-2" />
        ...
        {/* Resources Column */}
        {/* Responsive col-span: 1 column on all sizes */}
      ...
      {/* Adjusted height for responsiveness: h-48 for small screens, h-64 for sm and up */}
      <div
        className="relative w-full h-48 sm:h-64 mt-8" // Adjusted height for responsiveness
        style={{
      ...
      >
        ...
        {/* Adjusted text size for responsiveness: text-2xl for xs, text-3xl for sm, text-4xl for md and up */}
        <div
