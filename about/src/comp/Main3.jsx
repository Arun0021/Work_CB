...
// Main3 now receives isDarkMode as a prop
const Main3 = ({ isDarkMode }) => {
  ...
  const commonImageClasses = "max-w-full h-auto rounded-xl";
      ...
      <div className={commonContentWrapperClasses}>
        ...
        <div className={commonLeftContentClasses}>
          ...
          <div className={commonFeaturesGridClasses}>
            ...
            <div className={`${commonFeatureCardClasses} ${featureCardBgBorderClass}`}>
